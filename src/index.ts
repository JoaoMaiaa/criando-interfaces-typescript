...
class SaveUser implements SetUser{
    id: string
    login: string
    name: string
    bio: string
    ...
    constructor(id: string, login: string, name: string, bio: string, public_repos: number, repos_url: string){
        this.id = id,
        this.login = login,
        this.name = name,
        this.bio = bio,
...
class Repos implements SetRepos{
    name:string
    description:string
    fork:boolean
    stargarzers_count:number

    constructor(name:string, description:string, fork:boolean, stargarzers_count:number){
        this.name = name,
...
async function listRepos(url:string){
